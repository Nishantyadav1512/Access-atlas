...
import { runPageSpeedAudit, convertToAxeFormat } from '../utils/pagespeed.js';
...
router.post('/', authMiddleware, async (req, res) => {
    try {
        ...
        // Use PageSpeed Insights API (works on Render free tier)
        const { scores, audits } = await runPageSpeedAudit(url);
        const axeResults = convertToAxeFormat(audits);
